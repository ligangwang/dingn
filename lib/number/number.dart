...
@immutable
class Number {
  const Number(this.number, this.words, this.mostFavoriteWord,
      this.mostFavoriteCount, this.myFavoriteWord);
  ...
  Number setMostFavoriteWord(String mostFavoriteWord, int mostFavoriteCount) {
    return Number(
        number, words, mostFavoriteWord, mostFavoriteCount, myFavoriteWord);
  }
